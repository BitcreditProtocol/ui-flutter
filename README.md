...
Bitcredit code is MIT licensed. The bundled Geist fonts retain the SIL Open
Font License 1.1. [LICENSE](LICENSE) includes both notices so consumers receive
the font license with the library.
